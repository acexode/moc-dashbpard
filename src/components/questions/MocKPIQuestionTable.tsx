...
function applySortFilter(
  ...
  if (query) {
    return filter(
      array,
      (_user) =>
        _user?.sectionTitle?.toLowerCase().indexOf(query.toLowerCase()) !== -1
    );
  }
...
const MocKPIQuestionTable: FC<ITable> = ({
  dataList,
  page_title,
  table_Head,
  loading,
      ...
      <Page title={`${page_title}: List | BHCFP`}>
        <Container maxWidth={themeStretch ? false : "lg"}>
          <HeaderBreadcrumbs
            ...
            action={
              levels.national === userProfile?.level &&
              roles.super_admin === userProfile?.role ? (
                <Button
                  variant="contained"
                  onClick={toggle}
                        ...
                        .map((row: any, index: number) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell align="center">
                                {row?.budgetPercentInc}
                              </TableCell>
                              <TableCell align="center">
                                {row?.coveragePercenttInc}
                              </TableCell>
...
export default MocKPIQuestionTable;
