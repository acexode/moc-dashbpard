...
import { AddEdit } from "./components/add-edit-facility";
...
const FacilityTable: FC<ITable> = ({ dataList, page_title, table_Head,loading,fetchAllData ,locations}) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell align="right">
                                <MoreMenu handleUpdate={handleUpdate} row={row} fetchAllUsers={fetchAllData} type="Facility" />
                            </TableCell>
                          </TableRow>
                        );
                      })}
