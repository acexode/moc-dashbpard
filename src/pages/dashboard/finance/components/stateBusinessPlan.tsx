        ...
        },
        {
          ...
          Cell: ({ renderedCellValue, row }:any) => (
            ...
            >
              ...
              <Link style={{color:"#2f3842"}} to={`${PATH_DASHBOARD.financial_management.business_plan}/${row?.original?.state}/${renderedCellValue}`}>{renderedCellValue}</Link>
            </Box>
            </>
...
export default StateBusinessPlan