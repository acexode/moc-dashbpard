    ...
    const columns =[
        ...
        },
        {
          ...
          Cell: ({ renderedCellValue, row }:any) => (
            <Box
            >  
              <Link style={{color:"#2f3842"}} to={`${PATH_DASHBOARD.financial_management.viewLgaPlan}/${renderedCellValue}`}>{renderedCellValue}</Link>
            </Box>
          ),
        },
        {
...
export default LgaBusinessPlan